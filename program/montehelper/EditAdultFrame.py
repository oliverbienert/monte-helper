...
class EditAdultFrame(wx.Frame, WxHelpers, Helpers):
    ...
    def __set_properties(self):
        ...
        self.lv_email.SetMinSize((551, 60))
        ...
        self.lv_income.SetMinSize((551, 60))
    ...
    def __do_layout(self):
        ...
        self.sizer_38_staticbox.Lower()
        sizer_38 = wx.StaticBoxSizer(self.sizer_38_staticbox, wx.VERTICAL)
        sizer_42 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_15_copy = wx.BoxSizer(wx.HORIZONTAL)
        self.sizer_37_staticbox.Lower()
        sizer_37 = wx.StaticBoxSizer(self.sizer_37_staticbox, wx.VERTICAL)
        ...
        sizer_5_copy = wx.StaticBoxSizer(self.sizer_5_copy_staticbox, wx.VERTICAL)
        ...
        grid_sizer_1_copy.Add(self.l_name, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        grid_sizer_1_copy.Add(self.l_street, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        grid_sizer_1_copy.Add(self.l_city, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_3.Add(self.l_householdsize, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_12_copy.Add(self.l_fonnumber, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        sizer_12_copy.Add(self.fonnumber, 0, wx.ALL | wx.EXPAND, 1)
        sizer_12_copy.Add(self.l_fontype, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_36.Add(sizer_37, 0, wx.ALL | wx.EXPAND, 3)
        sizer_15_copy.Add(self.l_email, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        sizer_15_copy.Add(self.email, 0, wx.ALL, 1)
        sizer_15_copy.Add(self.label_4_copy, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_36.Add(sizer_38, 0, wx.ALL | wx.EXPAND, 3)
        sizer_24.Add(self.l_income, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        sizer_24.Add(self.income, 0, wx.ALL, 1)
        sizer_24.Add(self.l_incometype, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_36.Add(sizer_39, 0, wx.ALL | wx.EXPAND, 3)
        sizer_35.Add(self.b_ok, 0, 0, 0)
        sizer_35.Add(self.btn_Apply, 0, 0, 0)
        sizer_35.Add(self.b_cancel, 0, 0, 0)
        sizer_36.Add(sizer_35, 0, wx.ALL | wx.ALIGN_RIGHT, 3)
        self.panel_2.SetSizer(sizer_36)
        sizer_34.Add(self.panel_2, 1, wx.EXPAND, 0)
    ...
    def Populate(self, data, positions=[], fonnumbers=[], email=[], income=[]):
        self.obj = data
    ...
    def OnRefreshFon(self, event): # wxGlade: EditAdultFrame.<event_handler>
        ...
        if (self.fonnumberobject == None):
            ...
            self.fonnumberobject = {'fonnumber_id': None, 'fonnumbertype_id': dct['id'], 'description':dct['label'], 'number': self.fonnumber.GetValue()}
            self.lv_fonnumbers.AddObject(self.fonnumberobject)
            return
        elif (event_id == ID_TC):
